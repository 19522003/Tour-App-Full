...
<title>Destination: Da Lat</title>
...
<body>
	...
	<div class="banner_main_p3">
		<div class="img_banner_top">
			<img class="img_banner"
				src="https://i.ytimg.com/vi/2YGIbVf-LM4/maxresdefault.jpg" style="width: 100%;height: 800px; object-fit: cover"
				alt="Da Lat" />
		</div>
			...
			<div class="container">
				<div class="rutu">
					<form action="" class="wow bounceInLeft fadeInLeft"
						data-wow-delay=".2s">
						<i>A 11 day trip to Da Lat by Travel Agency 2377525</i> <span
	...
	<div class="mainwrapper">
		...
		<div class="wrapper_ title_top_header">
			<div class="container">
				<h2 class="text-center">Da Lat Tours &amp; Package Tours</h2>
				<div class="p_text_ninh_binh text-center">
					<p>
						<span> Da LAt is one of the top destination travel in
		...
		<div class="list_guide">
			<div class="container">
				<div class="list_guide_left">
					...
					List<Tour> list = dao.getAllDaLatTour();
					for (Tour p : list) {
					%>
	...
	<div class="banner_picture">
		<img src="https://datviettour.com.vn/uploads/images/tin-tuc/danh-muc-dia-danh-noi-tieng/linhquyphapung1.jpg" alt="Ha Long Tours &amp; Package Tours " />
	</div>
	<div class="main_wrapper2">
		<div class="heal">
			<%
