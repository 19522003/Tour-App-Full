...
<footer class="footer">
	...
	<div class="footer__more">
		...
		<div class="footer__more-popular">
			<h3>POPULAR VACATIONS</h3>
			<ul>
				<li><a href="#">Private Tours</a></li>
				<li><a href="#">Luxury Tours</a></li>
				<li><a href="#">Ha Giang Adventure and Motorbike</a></li>
				<li><a href="#">Explore Cave in Ninh Binh and Boat Trip</a></li>
				<li><a href="#">Cruise in Ha Long Bay</a></li>
				<li><a href="#">Mai Chau Adventure and Trekking Tours</a></li>
			</ul>
		</div>
	...
	<div class="footer__payment">
		...
		<div class="footer__payment-contact">
			<div class="footer__payment-contact__location">
				WEBTRAVEL All rights reserved <br /> Headquarter: UIT, Linh Trung,
				Thu Duc, TP Ho Chi Minh
			</div>
			<div class="footer__payment-contact__email">Contact:
				pts.uit.group@gmail.com</div>
